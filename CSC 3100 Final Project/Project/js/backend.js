...
const db = new sqlite3.Database('./SchoolSystem.db', (err) => {
    if (err) {
...
app.post('/api/auth/register', async (req, res) => {
    ...
    const query = `INSERT INTO tblUsers (FirstName, LastName, Email, Password, CreationDateTime) VALUES (?, ?, ?, ?, datetime('now'))`;
